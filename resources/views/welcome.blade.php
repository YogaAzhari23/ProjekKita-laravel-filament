        ...
        <div class="min-h-screen flex flex-col items-center">
            <header class="w-full py-6 px-6 sm:px-10 flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-semibold">ProjekKita</span>
                </div>
            ...
            <main class="flex-1 flex flex-col items-center justify-center w-full px-6 sm:px-10 py-12">
                <div class="max-w-4xl w-full">
                    <div class="text-center mb-12">
                        <h1 class="text-4xl md:text-5xl font-bold mb-4">Manajemen Proyek yang <span class="text-gradient">Disederhanakan</span></h1>
                        <p class="text-xl text-gray-600 max-w-4xl mx-auto">Sederhanakan alur kerja Anda dengan alat manajemen proyek yang intuitif dan kolaboratif, dirancang untuk tim dari berbagai ukuran.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">Manajemen Tugas</h2>
                            </div>
                            <p class="text-gray-600">Buat, tetapkan, dan pantau tugas dengan mudah. Atur prioritas dan tenggat waktu untuk menjaga tim Anda tetap berada di jalur yang benar.</p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">Kolaborasi Tim</h2>
                            </div>
                            <p class="text-gray-600">Tingkatkan kerja sama tim dengan pembaruan secara real-time. Pastikan semua anggota tim selalu mendapatkan informasi terbaru.</p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">Pelacakan Progress</h2>
                            </div>
                            <p class="text-gray-600">Visualisasikan kemajuan proyek melalui papan kerja dan laporan yang intuitif. Identifikasi hambatan dan optimalkan alur kerja.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <p class="mt-4 text-sm text-gray-500">Kelola proyek dan tim Anda melalui dashboard administrasi yang canggih.</p>
                    </div>
                </div>
            </main>
            ...
            <footer class="w-full py-8 px-6 sm:px-10">
                <div class="max-w-4xl mx-auto text-center">
                    <p class="text-gray-600">© {{ date('Y') }} ProjekKita. All rights reserved.</p>
                    <p class="text-sm text-gray-500 mt-2">Dibangun menggunakan Laravel dan Filament.</p>
                </div>
            </footer>
        </div>
    </body>
